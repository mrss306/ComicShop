document.addEventListener('DOMContentLoaded', function() {
    const form = document.querySelector('form[action="ProductInsert"]');
    ...
    const errorMessages = {
        ...
        img: "Devi selezionare un'immagine"
    };
